/* =============================================================================
   ...
   Fields:
     file      — path to the PDF/image, e.g. "documents-files/arz-e-multan.pdf"  (required)
...
window.DOCUMENTS = [
  ...
  { member:"Moin ul Haque", memberId:"b3-moin", category:"Poetry", title:"Daddy (ڈیڈی)", note:"An Urdu elegy for Sheikh Ahsan ul Haque, lovingly known as ‘Daddy’, written on his passing.", file:"documents-files/daddy-an-elegy.pdf" },
