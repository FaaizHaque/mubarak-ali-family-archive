...
window.DOCUMENTS = [
  ...
  { member:"Dr Muhammad Hamid", memberId:"hamid", category:"Book", title:"Biography of Imam Shamil", note:"His world-renowned biography of the 19th-century Caucasian leader and scholar Imam Shamil — translated into more than ten languages." },
  { member:"Dr Muhammad Hamid", memberId:"hamid", category:"Book", title:"Fatawa-e-Alamgiri (English translation)", note:"His English translation of Fatawa-e-Alamgiri, the classical compendium of Islamic jurisprudence — from the everyday matters of a Muslim's life to questions of inheritance and economics." },
  { member:"Dr Muhammad Hamid", memberId:"hamid", category:"Poetry", title:"Qaseeda Burdah Shareef (translations)", note:"His verse translations of the Qaseeda Burdah Shareef into four different languages." },
